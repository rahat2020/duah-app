...
export default function Home({data, subCat, duas, singleCategoryDua}) {
...
export const getStaticProps = async () => {
  ...
  const singleCategory = await fetch('http://localhost:5000/category/5')
  ...
  return {
    props: { data,subCat, duas, singleCategoryDua }
  }
}
